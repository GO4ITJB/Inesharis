...
const CelebrationDescription = ({
  ...
  if (language === "ba") {
    return (
      <div className="text-sm leading-relaxed text-wedding-brown/80 font-light">
        18:00-02:00 – Opustite se s nama{" "}
        <i className="fas fa-champagne-glasses text-wedding-pink mx-1"></i> i
        proslavite naš dan.
        <i className="fas fa-utensils text-wedding-pink mx-1"></i> Hrana,
        <i className="fas fa-music text-wedding-pink mx-1"></i> muzika,
        <GiPartyPopper
          className="inline text-wedding-pink mx-1"
          style={{ fontSize: "1.2rem" }}
        />{" "}
        ples i<i className="fas fa-heart text-wedding-pink mx-1"></i> ljubav!
      </div>
    );
  }
  ...
  return (
    <div className="text-sm leading-relaxed text-wedding-brown/80 font-light">
      18:00-02:00 – Släpp loss med oss{" "}
      <i className="fas fa-champagne-glasses text-wedding-pink mx-1"></i> och
      fira in vår dag.
  <span className="md:whitespace-nowrap"><i className="fas fa-utensils text-wedding-pink mx-1"></i> Mat,</span>
...
export default function RunOfShow({ language = "sv" }: RunOfShowProps) {
  ...
  const weddingSchedule = weddingScheduleStructure.map((item) => ({
    ...
    description:
      t.schedule[item.descriptionKey as keyof typeof t.schedule].description,
  ...
  return (
    <section
      id="run-of-show"
      className="relative z-[5] mt-[100vh] py-20 bg-wedding-sand text-wedding-dark shadow-lg"
    >
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-32">
          ...
          <p className="text-lg md:text-xl text-wedding-brown/70 font-light max-w-2xl mx-auto leading-relaxed mb-4">
            {t.programDescription}
          </p>

          <div className="text-wedding-pink font-medium text-lg tracking-wider mb-4">
            {t.weddingDate}
          </div>

          <div className="text-sm text-wedding-brown/60 font-light max-w-3xl mx-auto leading-relaxed">
            <p className="mb-2">
              {t.dressCodeDescription}
              <br />
              <em>{t.dressCodeNote}</em>
            </p>
          </div>
        </div>
                          ...
                          <div className="w-1/2 pr-12 text-right flex items-center justify-end">
                            <div className="mr-6">
                              ...
                              {event.description &&
                                ...
                                event.event === "SLAVLJE I PROSLAVA" ? (
